...
@register_task("vae")
class UniMolFinetunevaeTask(UnicoreTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        elif args.encoder == 'unimol-laser':
    ...
    def build_model(self, args):
        ...
        if args.finetune_encoder_model is not None:
                ...
                missing_keys, unexpected_keys = model.encoder.load_state_dict(state["model"], strict=False)
