...
class Edmori(BaseUnicoreModel):
    ...
    def __init__(self, args, dictionary):
        ...
        in_node_nf, self.nodes_dist, self.prop_dist = self.__init__vae(args, condition_data, num_atoms)
        ...
        self.vdm = EnVariationalDiffusion(
    ...
    def __init__vae(self, args, condition_data=None, num_atoms=None):
        ...
        return in_node_nf, nodes_dist, prop_dist
    ...
    def forward(
        ...
        **kwargs
        ...
        nll = self.vdm(x, h, node_mask, edge_mask.view(batch_size, n_nodes * n_nodes), context)
    ...
    def sample(
        ...
        device = self.vdm.dynamics.egnn.embedding.weight.device
...
@register_model_architecture("edm", "edm")
...
@register_model_architecture("edm", "edm-qm9")
def base_architecture(args):
    # encoder
...
@register_model_architecture("edm", "edm-oled")
def base_architecture(args):
    # encoder
...
@register_model_architecture("edm", "edm-opv")
def base_architecture(args):
    # encoder
