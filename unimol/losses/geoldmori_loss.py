...
@register_loss("finetune_geoldmori_loss")
class FinetunegeoldmoriLoss(CrossEntropyLoss):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        #     model.eval()
            ...
            #     model.sample_sweep_conditional(model.prop_dist)            
            # model.sample_chain(n_tries=1)
            # self.sample_different_sizes_and_save(model, node_dist, prop_dist)            
    ...
    def sample_different_sizes_and_save(self, model, nodes_dist, prop_dist=None, n_samples=32, epoch=0, batch_size=100):
