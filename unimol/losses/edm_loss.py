...
@register_loss("finetune_edm_loss")
class FinetuneedmLoss(CrossEntropyLoss):
    ...
    def sample_different_sizes_and_save(self, model, nodes_dist, n_samples=5, epoch=0, batch_size=100):
