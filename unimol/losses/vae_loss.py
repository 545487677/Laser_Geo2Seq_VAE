...
@register_loss("finetune_vae_loss")
class FinetunevaeLoss(CrossEntropyLoss):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        xent_loss, kl_loss = self.vae_loss(output.float(), target_smi_token.float(), mean.float(), logvar.float())
