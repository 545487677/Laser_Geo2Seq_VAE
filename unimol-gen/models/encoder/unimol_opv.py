...
@register_model("unimol-opv")
class UniMolOPVModel(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
...
@register_model_architecture("unimol", "unimol-opv")
...
@register_model_architecture("unimol", "unimol_opv_small")
