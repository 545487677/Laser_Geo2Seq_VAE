...
@register_model("unimol_ori")
class UniMolOriModel(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, dictionary):
        ...
        self.classification_heads = ClassificationHead(
            ...
            inner_dim=self.args.encoder_embed_dim * 2, 
...
@register_model_architecture("unimol_ori", "unimol_ori")
...
@register_model_architecture("unimol_ori", "unimol_ori_base")
